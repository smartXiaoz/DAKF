...
%         v = stblrnd(1.2,0,3,0,q,NN)*0.1;%alpha 分布噪声
...
%     [R_pai,RR1,RR2]=EM_GMM2(v,0,0);
    ...
    %     R2=v2*v2'/Len;
     %% ***
    gmm=fitgmdist(v', 2,'RegularizationValue', 1e-6);
    ...
    P0_emkf_cv = p0;
    for i=2:Len
        [Pkk_EMKF_CV,X_em_CV]=F_EMKF2(A1,G1,H,Q1,R,zA(:,i),x0_emkf_cv,P0_emkf_cv,p,RR1,RR2, R_pai,0,0);
        X_ikv(:,i)=X_em_CV;
