...
%     mu2 = 5;
    ...
    v1=randn(m,NN)*0.1 ; v2=randn(m,NN)*10 ;v3 = rand(m,NN)*2-1;v4 =  sin(randn(m,NN));
    rp=rand(1,NN);  
    v4=randn(m,NN)*40;
    %case1
%     r = v1;
...
plot(20*log10((Err_EM_KF1)),'b.-','LineWidth',1.5,'markersize',10);

plot(20*log10(Err_MCC_TH1*ones(1,N)),'g-^','LineWidth',2,'MarkerIndices',mark_idx);

h=legend('KF', 'MCKF \sigma=6', 'MEEKF \sigma=2', 'Proposed DAKF','TH-DAKF');
set(h,'FontName','Times New Roman','FontSize',24,'FontWeight','normal');
set(gca,'fontsize',24);
xlabel('Iterations','FontSize',24);
...
A_MCC= 20*log10(mean(Err_MCC_KF1(:,200:end)))
A_MEE= 20*log10(mean(Err_MEE_KF1(:,200:end)))
