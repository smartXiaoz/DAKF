...
plot(20*log10((Err_MCC_KF2)),'c','LineWidth',wid);
plot(20*log10((Err_MEE_KF2)),'r','LineWidth',wid);
...
h=legend('KF', 'MCKF \sigma=10', 'MEEKF \sigma=6', 'Proposed DAKF','TH-DAKF');
set(h,'FontName','Times New Roman','FontSize',24,'FontWeight','normal','orientation','horizontal');
set(gca,'fontsize',24);
xlabel('Iterations (case2)','FontSize',24);
